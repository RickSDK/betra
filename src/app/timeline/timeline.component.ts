...
export class TimelineComponent implements OnInit {
  ...
  public people:any = [
    {name: 'Nebuchadnezzar', born: 642, death: 562, color: 'orange', top: '70px', reign: '344px'},
    {name: 'Cyrus', born: 600, death: 530, color: 'orange', top: '100px', reign: '232px'},
    {name: 'Cambyses II', born: 565, death: 522, color: 'red', top: '130px', reign: '64px'},
    {name: 'Darius', born: 550, death: 486, color: 'orange', top: '160px', reign: '288px'},
    {name: 'Xerxes', born: 518, death: 465, color: 'orange', top: '190px', reign: '168px'},
    {name: 'Artaxerxes', born: 500, death: 424, color: 'orange', top: '220px', reign: '328px'},
