...
export class OwnersComponent extends BaseComponent implements OnInit {
  ...
  override postSuccessApi(file: string, responseJson: any) {
    ...
    if (responseJson.action == 'getMyOwnerInfo') {
      ...
      if (level == 4)
        this.goalReachedFlg = (responseJson.messageCount > 299 && responseJson.reviewCount > 5 && responseJson.picVerifiedCount > 4 && responseJson.referralCount >= 2 && responseJson.giftsGiven > 4 && responseJson.picsRequested > 11 && responseJson.picsTaken > 1 && responseJson.consecutiveDays > 13);
